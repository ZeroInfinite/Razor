...
namespace Microsoft.AspNetCore.Razor.Evolution.Legacy
{
    ...
    internal class TagHelperDescriptorProvider
    {
        ...
        public TagHelperDescriptorProvider(
            ...
            string parentTagName)
        {
            ...
            foreach (var descriptor in descriptors)
            {
                var applicableRules = descriptor.TagMatchingRules.Where(rule =>
                    VerifyRule(rule, attributes, parentTagName));
        ...
        private bool VerifyRule(TagMatchingRule rule, IEnumerable<KeyValuePair<string, string>> tagAttributes, string parentTagName)
        {
            // Verify parent tag
